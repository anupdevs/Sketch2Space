...
export default function Home() {
    ...
    const handleUploadComplete = async (base64Image: string) => {
        try {
            ...
            if (!saved) {
                console.warn("Failed to save project to cloud storage; proceeding locally.");
            }
            ...
            navigate(`/visualizer/${newId}`, {
                state: {
                    ...
                    initialRender: projectToUse.renderedImage || null,
                    name
                }
            });
      ...
      <div className="home">
          ...
          <section className="hero">
              <div className="announce">
                  ...
                  <p>Introducing Sketch2Space</p>
              </div>

              <h1>Build beautiful spaces at the speed of thought with Sketch2Space</h1>

              <p className="subtitle">
                  Sketch2Space is an AI-first design environment that helps you visualize, render, and ship architectural projects faster  than ever.
              </p>
